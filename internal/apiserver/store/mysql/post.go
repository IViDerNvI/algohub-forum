...
func (ps *postStore) GetById(ctx context.Context, id int, opt model.GetOptions) (*model.Post, error) {
	ret := &model.Post{}
...
func (ps *postStore) DeleteById(ctx context.Context, id int, opt model.DeleteOptions) error {
	return ps.db.Where("id = ?", id).Delete(&model.Post{}).Error
}

func (ps *postStore) List(ctx context.Context, opt model.ListOptions) (*model.PostList, error) {
	ret := &model.PostList{}
	d := ps.db.
